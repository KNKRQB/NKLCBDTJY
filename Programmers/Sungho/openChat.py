...
def solution2(record):
    ...
    users = {}
    #users = {uid : name, ...}
    #users = [[uid1, uid2, uid3, ...] , [name1, name2, ...]]
    priOut = [[-1], [-1]]
    #priOut = [[uid1, uid2, ...] , [order1, order2, ...]]
...
solution2(["Enter uid1234 Muzi", "Enter uid4567 Prodo","Leave uid1234","Enter uid1234 Prodo","Change uid4567 Ryan"])